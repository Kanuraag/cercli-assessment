...
/**
 * Entity class representing table employee
 * Attributes
 * employee_id type UUID Primary Key
 * name type String
 * email type String
 ...
 * composite unique key of name and email
 *
 * Annotations Used
 * @Entity : Denotes table in JPA
 * @Table: Define which table in DB it assosciates or represents
 * @NoArgsConstructor; Creates one no argument constructor
